...
def get_args():
    ...
    parser.add_argument("--input_dir", default="../LVIS_Dataset/LVIS/lvis_v1", type=str, help="img folder")
    parser.add_argument("--save_dir", default="../Processed_LVIS", type=str, help="save images folder")
    parser.add_argument("--annotation_file", default="../LVIS_Dataset/LVIS/lvis_v1/annotations", type=str, help="img folder")                      
